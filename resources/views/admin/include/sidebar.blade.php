      ...
      <ul class="sidebar-menu">
        ...
        <li class="@if(url('/data_pendaftar') == request()->url() or url('/input_data') == request()->url() ) active @else '' @endif treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{{ URL::to('input_data') }}}"><i class="fa @if(url('/input_data') == request()->url()) fa-dot-circle-o @else fa-circle-o @endif"></i> Input Data </a></li>
            <li><a href="{{{ URL::to('data_pendaftar') }}}"><i class="fa @if(url('/data_pendaftar') == request()->url()) fa-dot-circle-o @else fa-circle-o @endif"></i> Olah Data </a></li>
          </ul>
        </li>
		    <li class="@if(url('/kelola_prodi') == request()->url()) active @else '' @endif treeview">
          <a href="{{{ URL::to('kelola_prodi') }}}">
        ...
        <li class="@if(url('/kelola_kriteria') == request()->url() or url('/kelola_tabel') == request()->url() ) active @else '' @endif treeview">
          <a href="#">
            ...
            <span class="pull-right-container">
		      ...
		      <ul class="treeview-menu">
            <li><a href="{{{ URL::to('kelola_kriteria') }}}"><i class="fa @if(url('/kelola_kriteria') == request()->url()) fa-dot-circle-o @else fa-circle-o @endif"></i> Kelola Kriteria </a></li>
            <li><a href="{{{ URL::to('kelola_tabel') }}}"><i class="fa @if(url('/kelola_tabel') == request()->url()) fa-dot-circle-o @else fa-circle-o @endif"></i> Kelola Bobot </a></li>
          </ul>
        </li>
